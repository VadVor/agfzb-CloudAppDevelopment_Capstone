...
def get_dealer_reviews_from_cf(url, dealerId):
    ...
    if json_result:
        ...
        for dealer_doc in dealers:
            ...
            dealer_obj.sentiment=analyze_review_sentiments(dealer_doc["review"])
...
def analyze_review_sentiments(review):
    ...
    natural_language_understanding = NaturalLanguageUnderstandingV1(version='2023-04-16',authenticator=authenticator)
